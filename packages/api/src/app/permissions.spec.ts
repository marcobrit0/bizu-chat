import { loadDefaultInterface } from '@bizu/data-schemas';
import { SystemRoles, Permissions, PermissionTypes, roleDefaults } from 'bizu-data-provider';
import type { TConfigDefaults, TCustomConfig } from 'bizu-data-provider';
