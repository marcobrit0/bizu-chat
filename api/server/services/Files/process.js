...
const { sanitizeFilename, parseText, processAudioFile } = require('@bizu/api');
const {
  convertImage,
  resizeAndConvert,
  resizeImageBuffer,
 ...
 * @param {RunClient} params.client - The Bizu client instance: either refers to `openai` or `streamRunManager`.
 * @param {string} params.file_id - The ID of the file to retrieve.
