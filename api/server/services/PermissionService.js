...
const { getTransactionSupport, logger } = require('@bizu/data-schemas');
const { ResourceType, PrincipalType, PrincipalModel } = require('bizu-data-provider');
const {
...
/**
 * @import { TPrincipal } from 'bizu-data-provider'
 */
/**
