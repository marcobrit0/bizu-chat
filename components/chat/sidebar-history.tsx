  ...
  return (
    <>
      ...
      <AlertDialog onOpenChange={setShowDeleteDialog} open={showDeleteDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>{ui.sidebar.deleteChatTitle}</AlertDialogTitle>
            <AlertDialogDescription>
              {ui.sidebar.deleteChatDescription}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel>{ui.sidebar.cancel}</AlertDialogCancel>
            <AlertDialogAction onClick={handleDelete}>
              {ui.sidebar.deleteConfirm}
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
